...
{\color{red}Recall that for a group $G$, a $G$-torsor consists of a nonempty set $X$ and
...
In the case where $G$ is $\ZZ$, then since $\ZZ$ is a free group with one generator, an action on $X$ is completely 
determined by the action of the integer $1$: it is a bijection $X \to X$ which we denote by $f$.
