...
observing that $n + x = f^n(x)$ for all $n \in \ZZ$.  Alternatively, one could define an action of $\ZZ$ on $X$ by setting $n + x := f^n(x)$,
and then use the existence of $e$ to show that the action is free and transitive and to show that $X$ is nonempty.
