...
See \cite{Z-induction-formalized,Z-induction-torsor-formalized} for the formalization of the proof, as well as the formalization of a version
for $\zet$-torsors.
...
that of \cref{sec:TorZ-recursion} in \cite{circleind-Dan}.}
...
We introduce the induction principle for propositional truncation in the following form (compare with \cite[6.9]{hottbook}).
