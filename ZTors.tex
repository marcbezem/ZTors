...
path from the element to itself, an induction principle (for defining functions from it),
and nothing more.  Because {\UniMath}, by a conservative convention aimed at minimizing the burden of proving
