...
In set-theoretic foundations of mathematics, the {\em sets} have no interesting internal structure---\emph{qua} collections of elements---aside from the identity of these elements.
