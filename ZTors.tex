...
\title{Construction of the circle in \UniMath}
{
    ...
    \urladdr{https://www.ae-info.org/ae/Member/Bezem\_Marc}
}
{
...
\end{lemma}
The proof is by induction on $r$, reducing to the conclusion
of~\cref{lem:unitlaw-change-path}.
...
\]
where $\tilde A_s(y) \defeq (y =^A_{\Zloop_s} y)$.
