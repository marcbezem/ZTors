...
\usepackage[colorlinks,
            ...
            pdfkeywords={type theory,univalence foundations,circle}]{hyperref}
% - except for cleveref!
...
%%% Rules/conditions
\makeatletter
\def\condlabel#1#2{\begingroup
  #2%
  \protected@edef\cref@currentlabel{[cond][][]#2}%
  \phantomsection\label[cond]{#1}%
  \endgroup
}
\makeatother
\crefformat{cond}{(#2#1#3)}

% Should these be roman or italic?!
\newcommand{\bool}{\mathop{\mathrm{Bool}}}
\newcommand{\yes}{\mathop{\mathrm{yes}}}
\newcommand{\no}{\mathop{\mathrm{no}}}
\newcommand{\set}[1]{\{#1\}}
\newcommand{\invo}{^{-\mathrm{o}}}
\newcommand{\refl}[1]{\mathop{{\mathrm{refl}}_{#1}}}
\newcommand{\reflo}[1]{\mathop{{\mathrm{refl}}_{#1}}} % rofl?
\newcommand{\refloi}[1]{\mathop{\mathrm{refl}\invo_{#1}}}
\newcommand{\inl}[1]{\mathop{{\it inl}_{#1}}}
\newcommand{\inr}[1]{\mathop{{\it inr}_{#1}}}
\newcommand{\true}{\mathop{\mathrm{True}}}
\newcommand{\false}{\mathop{\mathrm{False}}}
\newcommand{\triv}{\mathop{\mathrm{triv}}}
\newcommand{\symm}{\mathop{\mathrm{symm}}}
\newcommand{\trans}{\mathop{\mathrm{trans}}}
\newcommand{\fact}{\mathop{\mathrm{fact}}}
\newcommand{\trp}[1]{\mathop{\mathrm{trp}_{#1}}}
...
\newcommand{\apc}{\mathop{\mathrm{ap}_{\ct}}}
...
\newcommand*{\texthyphen}{\textup{\kern.5pt-\kern-.5pt}}
\newcommand{\CircleAlg}{\mathord{\mathbb{S}\texthyphen\mathrm{Alg}}}
\newcommand{\CircleFibAlg}{\mathord{\mathbb{S}\texthyphen\mathrm{Fib}\texthyphen\mathrm{Alg}}}
...
\newcommand{\isom}{\cong}
\newcommand{\ct}{*}
\newcommand{\cto}{\mathbin{*_{\mathrm{o}}}}
\newcommand{\cp}[1]{\mathrm{cp}_{#1}}
\newcommand*{\dblslash}{\mathbin{/\kern-3pt/}}
\newcommand*{\Shom}{\mathop{\mathbb{S}\texthyphen\mathrm{hom}}}
\newcommand*{\Ssect}{\mathop{\mathbb{S}\texthyphen\mathrm{sect}}}
...
\def\mathrule#1#2{%
  \@tempdimb=\dimexpr#2
  \@tempdimc=0.5\@tempdimb
  \@tempdima=\dimexpr#1-\@tempdimc
  \hbox to #1{%
    \pdfliteral{
      q []0 d
...
\makeatletter
\newcommand*{\blank}{\mathord{\mathchoice%
    {\mathrule{.5em}{.5pt}}% display
    {\mathrule{.5em}{.5pt}}% text
    {\mathrule{.4em}{.4pt}}% script
    {\mathrule{.3em}{.3pt}}% scriptscript
  }}
...
\newcommand{\revers}{\mathrm{r}}
\newcommand{\twist}{\mathrm{twist}}%loop in BC_2
\newcommand{\Sc}{{\mathbb{S}^1}}%the circle
...
\newcommand{\zet}{\mathbb{Z}}%the SET of integers
